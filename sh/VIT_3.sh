...
#SBATCH --job-name=no_cyclic_3      # Set a name for the job
#SBATCH --cpus-per-task=8         # Allocate 8 CPU cores for data loading
#SBATCH --output=/om2/user/raduba/vision-transformers/log/output_vit_no_cyclic_3.log  # Save stdout in log folder
#SBATCH --error=/om2/user/raduba/vision-transformers/log/error_vit_no_cyclic_3.log    # Save stderr in log folder
...
srun python train_cifar10.py \
  ...
  --n_epochs 800 \
  &> /om2/user/raduba/vision-transformers/log/train_vit_no_cyclic_3.log
